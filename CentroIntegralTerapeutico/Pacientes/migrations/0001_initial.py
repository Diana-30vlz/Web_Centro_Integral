...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_type",
                    models.CharField(
                        choices=[("doctor", "Doctor"), ("farmacia", "Farmacia")],
                        default="doctor",
                        max_length=10,
                    ),
                ),
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                "^\\d{4}$", "El NIP debe ser un número de 4 dígitos."
                            )
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ta",
                    models.CharField(
                        blank=True, max_length=20, null=True, verbose_name="T/A"
                    ),
                ),
                ("fc", models.IntegerField(blank=True, null=True, verbose_name="F.C.")),
                (
                    "sat_o2",
                    models.IntegerField(blank=True, null=True, verbose_name="SAT. O2"),
                ),
                (
                    "medico",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comentarios",
                    models.TextField(
                        blank=True, null=True, verbose_name="ComentariosAdicionales"
                    ),
                ),
                (
                    "GradoInstruccion",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            (
                                "Casa independiente (particular)",
                                "Casa independiente (particular)",
                            ),
                            (
                                "Departamento en edificio o condominio",
                                "Departamento en edificio o condominio",
                            ),
                            ...
                            (
                                "Vivienda en local no construido para habitación",
                                "Vivienda en local no construido para habitación",
                            ),
                            (
                                "Vivienda móvil (casa rodante, barco, etc.)",
                                "Vivienda móvil (casa rodante, barco, etc.)",
                            ),
                            (
                                "Refugio (albergue, casa hogar, etc.)",
                                "Refugio (albergue, casa hogar, etc.)",
                            ),
                ...
                (
                    "Personas_que_habitan",
                    models.CharField(
                        blank=True,
                        max_length=100,
                        null=True,
                        verbose_name="Personas que habitan en la vivienda",
                    ),
                ),
                (
                    "Parentesco",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Parentesco"
                    ),
                ),
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(
                            ...
                            choices=[
                                ...
                                (
                                    "flexitariana",
                                    "Flexitariana (principalmente vegetariana, poca carne)",
                                ),
                                ("keto", "Cetogénica (Keto)"),
                                ("paleo", "Paleo"),
                                ("otra", "Otra (especifique)"),
                                ("no_aplica", "No aplica / No sabe / No responde"),
                            ],
                            default=Pacientes.models.get_default_servicios,
                            max_length=50,
                            null=True,
                ...
                (
                    "Ingesta_Agua",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Ingesta de agua litros"
                    ),
                ),
                (
                    "Cantidad_veces_Orina",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Cantidad de veces de orina"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Constitucional",
                    ),
                ),
                (
                    "Marcha",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Marcha"
                    ),
                ),
                (
                    "Actitud",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Actitud"
                    ),
                ),
                (
                    "Ubicacion",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Impresión General",
                    ),
                ),
                (
                    "FC",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Temperatura Auxiliar",
                    ),
                ),
                (
                    "T_rectal",
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Temperatura Rectal",
                    ),
                ),
                (
                    "Peso_Habitual",
                ...
                (
                    "Talla",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Talla"
                    ),
                ),
                (
                    "IMC",
                ...
                (
                    "Aspecto",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Aspecto"
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Distribución pilosa",
                    ),
                ),
                (
                    "Lesiones",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Lesiones"
                    ),
                ),
                (
                    "Faneras",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Faneras"
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Tejido celular subcutáneo",
                    ),
                ),
                (
                    "Tejido_celular",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="PacienteHistoriaClinicaME",
                        to="Pacientes.paciente",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "motivo_consulta",
                    models.TextField(
                        blank=True, null=True, verbose_name="Motivo de Consulta"
                    ),
                ),
                (
                    "enfermedad_actual",
                ...
                (
                    "art_subastragalina_f",
                    models.CharField(blank=True, max_length=50, null=True),
                ),
                (
                    "art_subastragalina_ev",
                    models.CharField(blank=True, max_length=50, null=True),
                ),
                (
                    "nasal_mucosa",
                ...
                (
                    "nasal_vascularizacion",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "me_pulso_carotideo_derecho",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Carotídeo Derecho",
                    ),
                ),
                (
                    "me_pulso_carotideo_izquierdo",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Carotídeo Izquierdo",
                    ),
                ),
                (
                    "me_pulso_humeral_derecho",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Humeral Derecho",
                    ),
                ),
                (
                    "me_pulso_humeral_izquierdo",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Humeral Izquierdo",
                    ),
                ),
                (
                    "me_pulso_radial_derecho",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Radial Derecho",
                    ),
                ),
                (
                    "me_pulso_radial_izquierdo",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Radial Izquierdo",
                    ),
                ),
                (
                    "me_pulso_femoral_derecho",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Femoral Derecho",
                    ),
                ),
                (
                    "me_pulso_femoral_izquierdo",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Femoral Izquierdo",
                    ),
                ),
                (
                    "me_pulso_popliteo_derecho",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Poplíteo Derecho",
                    ),
                ),
                (
                    "me_pulso_popliteo_izquierdo",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Poplíteo Izquierdo",
                    ),
                ),
                (
                    "me_pulso_tibial_posterior_derecho",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Tibial Posterior Derecho",
                    ),
                ),
                (
                    "me_pulso_tibial_posterior_izquierdo",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Tibial Posterior Izquierdo",
                    ),
                ),
                (
                    "me_pulso_pedio_derecho",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Pedio Derecho",
                    ),
                ),
                (
                    "me_pulso_pedio_izquierdo",
                    models.CharField(
                        blank=True,
                        max_length=50,
                        null=True,
                        verbose_name="Pulso Pedio Izquierdo",
                    ),
                ),
                ("ascitis", models.BooleanField(default=False)),
                ("Estado_Conciencia", models.TextField(blank=True, null=True)),
                (
                    "glasgow_apertura_ojos_respuesta",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "glasgow_apertura_ojos_puntuacion",
                    models.IntegerField(blank=True, null=True),
                ),
                (
                    "glasgow_respuesta_verbal_respuesta",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "glasgow_respuesta_verbal_puntuacion",
                    models.IntegerField(blank=True, null=True),
                ),
                (
                    "glasgow_respuesta_motora_respuesta",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "glasgow_respuesta_motora_puntuacion",
                    models.IntegerField(blank=True, null=True),
                ),
                (
                    "reflejo_fotomotor_tamano",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "reflejo_fotomotor_relaciones",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "reflejo_fotomotor_respuestas_luz",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "par_craneal_iii_oculomotor",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "par_craneal_iv_patetico",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "par_craneal_vi_motor_ocular_externo",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "par_craneal_iii_oculomotor_cv",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "par_craneal_iv_patetico_cv",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="PacienteHistoriaClinica",
                        to="Pacientes.paciente",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            name="ConsentimientoInformadoReal",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "fecha_procedimiento",
                    models.DateField(verbose_name="Fecha del Procedimiento"),
                ),
                (
                    "tuvo_tratamiento_similar",
                    models.BooleanField(
                        default=False, verbose_name="¿Tuvo tratamiento similar?"
                    ),
                ),
                (
                    "cual_tratamiento",
                ...
                (
                    "nombre_producto_aplico",
                    models.CharField(
                        blank=True,
                        max_length=255,
                        null=True,
                        verbose_name="Nombre del producto aplicado",
                    ),
                ),
                (
                    "reaccion_duro",
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Duración de la reacción",
                    ),
                ),
                (
                    "alergia_medicamento",
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        verbose_name="Alérgico a qué medicamento",
                    ),
                ),
                (
                    "insuficiencia_hepatica",
                    models.BooleanField(
                        default=False, verbose_name="Sufre de insuficiencia hepática"
                    ),
                ),
                (
                    "insuficiencia_renal",
                    models.BooleanField(
                        default=False, verbose_name="Sufre de insuficiencia renal"
                    ),
                ),
                (
                    "emergencia_llamar_a",
                    models.CharField(
                        max_length=255, verbose_name="Contacto de emergencia"
                    ),
                ),
                (
                    "emergencia_telefono",
                ...
                (
                    ...
                    models.CharField(
                        max_length=100, verbose_name="Identificación Oficial"
                    ),
                ),
                (
                    "nombre_testigo",
                    models.CharField(max_length=255, verbose_name="Nombre del Testigo"),
                ),
                (
                    "domicilio",
                    models.CharField(
                        blank=True, default="", max_length=255, verbose_name="Domicilio"
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="consentimientos_reales",
                        to="Pacientes.paciente",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "temp",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="Temperatura"
                    ),
                ),
                (
                    "peso",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="Peso"
                    ),
                ),
                (
                    "talla",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="Talla"
                    ),
                ),
                (
                    "ta",
                    models.CharField(
                        ...
                        max_length=50,
                        null=True,
                        verbose_name="T/A (Tensión Arterial)",
                    ),
                ),
                (
                    "rp",
                    models.TextField(
                        blank=True,
                        null=True,
                        verbose_name="Rp. (Receta o Recomendación)",
                    ),
                ),
                (
                    "paciente",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="consentimientos_simplificados",
                        to="Pacientes.paciente",
                    ),
                ),
            ],
