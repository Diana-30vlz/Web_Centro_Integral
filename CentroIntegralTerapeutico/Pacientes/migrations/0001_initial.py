    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ocupacion', models.CharField(blank=True, max_length=25, null=True)),
                ('Estado_Civil', models.CharField(blank=True, choices=[('Soltero/a', 'Soltero/a'), ('Casado/a', 'Casado'), ('Divorciado/a', 'Divorciado/a'), ('Viudo/a', 'Viudo/a'), ('Separado/a', 'Separado/a'), ('Unión_libre', 'Unión libre')], max_length=25, null=True)),
                ('Nacionalidad', models.CharField(blank=True, choices=[('Mexicana', 'Mexicana'), ('Extranjero', 'Extranjero')], max_length=25, null=True)),
                ('Residencia_Anterior', models.CharField(blank=True, help_text='En caso de aplicar', max_length=50, null=True)),
                ('Religion', models.CharField(blank=True, max_length=25, null=True)),
                ('Pasatiempo', models.CharField(blank=True, max_length=25, null=True)),
                ('Deporte_que_practica', models.CharField(blank=True, max_length=25, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historiales_musculoesqueleticos', to='Pacientes.paciente')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cual_tratamiento', models.CharField(blank=True, max_length=255, null=True, verbose_name='¿Cuál tratamiento?')),
                ('hace_cuanto_tiempo', models.CharField(blank=True, max_length=100, null=True, verbose_name='¿Hace cuánto tiempo?')),
                ('nombre_medico_autorizado', models.CharField(default='Jaqueline Vázquez Gómez', max_length=255, verbose_name='Médico que autoriza')),
                ('nombre_producto_aplico', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nombre del producto aplicado')),
                ('reaccion_duro', models.CharField(blank=True, max_length=100, null=True, verbose_name='Duración de la reacción')),
                ('alergia_medicamento', models.CharField(blank=True, max_length=255, null=True, verbose_name='Alérgico a qué medicamento')),
                ...
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consentimientos_reales', to='Pacientes.paciente')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motivo', models.CharField(choices=[('Consulta', 'Consulta General'), ('Seguimiento', 'Seguimiento'), ('Terapia', 'Sesión de Terapia'), ('Suero', 'Suero'), ('Otro', 'Otro')], default='Consulta', max_length=50, verbose_name='Motivo de la Cita')),
                ...
                ('asistencia', models.CharField(choices=[('S', 'Sí asistió'), ('N', 'No asistió'), ('P', 'Pendiente')], default='P', max_length=1, verbose_name='Asistencia a Cita')),
